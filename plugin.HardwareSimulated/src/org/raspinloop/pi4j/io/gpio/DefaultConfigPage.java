...
import org.raspinloop.fmi.plugin.preferences.HardwareUtils;
...
public class DefaultConfigPage extends AbstractHWConfigPage {
	...
	public void createControl(Composite p) {
		...
		supportedHardwares = HardwareUtils.buildHardwareListImplementing(BoardExtentionHardware.class);
	 ...
	 * @param hw the HW to initialize from
	 */
