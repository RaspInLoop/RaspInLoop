...
public class SvgFactory {
	 ...
	 * 
	 * @param i
	 *            an Icon object build form modelica annotation
	 * @param cssClass
	 * @return the SVG representation of the Icon
	 * @throws IOException
	 * @throws XMLStreamException
	 */
	public String build(Icon i, String cssClass) throws IOException, XMLStreamException {
		...
		if (i != null) {
			...
			// duc.convert(size.getWidth())+" "+ duc.convert(size.getHeight()));
