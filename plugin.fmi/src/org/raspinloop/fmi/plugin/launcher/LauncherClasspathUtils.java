...
public class LauncherClasspathUtils {
	...
	private static Collection<? extends String> getLauncherCP(ILaunchConfiguration configuration) {
		return Arrays.asList(getLauncherPath("target/classes"), //debug 
							 ...
							 getLauncherPath("target/dependency/pi4j-core-1.1.jar"),
							 getLauncherPath("target/dependency/pi4j-device-1.1.jar"), 
							 getLauncherPath("target/dependency/pi4j-example-1.1.jar"),
							 getLauncherPath("target/dependency/pi4j-gpio-extension-1.1.jar"), 
							 getLauncherPath("target/dependency/pi4j-service-1.1.jar"),
